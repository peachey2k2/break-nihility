...
## Usage example:
## [codeblock]
## var formatter = DecimalFormatterGD.new()
## var number = Decimal.from_float(1234567.89)
## 
## # Format with abbreviation
## formatter.abbreviation_type = DecimalFormatterGD.AbbreviationType.SHORT
## print(formatter.format(number))  # "1.23 M"
## 
## # Format with full number
## formatter.format_mode = DecimalFormatterGD.FormatMode.FULL
